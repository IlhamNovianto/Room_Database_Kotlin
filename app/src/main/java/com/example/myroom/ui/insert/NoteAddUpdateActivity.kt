...
import com.example.myroom.ViewModelFactory
import com.example.myroom.database.Note
import com.example.myroom.databinding.ActivityNoteAddUpdateBinding
import com.example.myroom.helper.DateHelper

class NoteAddUpdateActivity : AppCompatActivity() {
//menginisialisasi view yang ada di layout-nya.
    companion object{
        const val EXTRA_NOTE = "extra_note"
        const val ALERT_DIALOG_CLOSE = 10
        const val ALESRT_DIALOG_DELETE =20
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Fungsi dari button atau behavior
...
//Button Action
    ...
    //Menambahkan Fungsi menghapus databse tersimpan
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_delete -> showAlertDialog(ALESRT_DIALOG_DELETE)
